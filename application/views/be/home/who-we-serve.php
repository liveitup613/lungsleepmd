...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Syston Iterations | Who We Serve</title>
        ...
        <link href="<?php echo base_url('assets/css/pages/be/who-we-serve.css');?>" rel="stylesheet" type="text/css" />
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Who We Serve Content</span>
                                            </div>                                         
                                        </div>
                                                        ...
                                                        <div class='col-md-4 col-sm-6 col-xs-12'>
                                                            ...
                                                            <div class="portlet light profile-portlet">
                                                                ...
                                                                <div class="profile-pic">
                                                                    <img src="<?php echo base_url('assets/images/whoweserve/'.$service['Portfolio']);?>" class="img-responsive" alt="">
                                                                    <?php
                                                                        if ($service['Enable'] === 'YES')
                                                                            echo "<span class='badge badge-danger'><i class='fa fa-check'></i></span>";
                                                                    ?>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/home/whoweserve.js');?>" type="text/javascript"></script>
