...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/frontend/css/font.css');?>" type="text/css" media="all">
                                    ...
                                    <div class='main-container'>
                                        ...
                                        <div class="header__breadcrumb"
                                            style="background-blend-mode: multiply;
                                                    background-image:url(<?php echo base_url('assets/frontend/images/medicus181.jpeg');?>);
                                                    background-color : rgb(174 245 194 / 68%);
                                                    background-size: cover;
                                                    background-position: center;">
                                            <h1 class="header__breadcrumb--title">Sleep Medicine</h1>
                                        </div>
                                        ...
                                        <main class="main">
                                            <div class="service-container container-small">
                                                <div class='content'>
                                                    <div class='portfolio'>
                                                        <img src='<?php echo base_url('assets/frontend/images/sleep-medicine.jpg');?>'>
                                                    </div>
                                                    <div class='row'>     
