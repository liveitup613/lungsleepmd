...
<body
                                            ...
                                            <div class="service-container">
                                                <div class='content'>
                                                    <div class='video-preview'>
                                                        <iframe src="https://www.youtube.com/embed/1rjN2_hDXEY" id='youtube-video'>
                                                        </iframe>
                                                    </div>
                                                    <div class='video-box'>
                                                        <?php
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/frontend/scripts/pages/medical-videos.js');?>"></script>
