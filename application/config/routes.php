...
$route['api/staff/add'] = 'manageAboutUs/addStaff';
$route['api/staff/get'] = 'manageAboutUs/getStaff';
$route['api/staff/update'] = 'manageAboutUs/updateStaff';
$route['api/staff/delete'] = 'manageAboutUs/deleteStaff';
