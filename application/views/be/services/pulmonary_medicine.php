...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Pulmonary Medicine | Epignosis Specialty Practice</title>
    ...
    <body class="page-container-bg-solid page-boxed">     
        ...
        <?php 
            ...
            $menu['current'] = 'pulmonary_medicine';
                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span href="#">Pulmonary Medicine</span>  
                            </li>                            
                        </ul>
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Pulmonary Medicine Content</span>
                                            </div>                                         
                                        </div>
                                        <div class="portlet-body form">
                                            <!-- BEGIN FORM-->
                                            <form action="#" class="form-horizontal form-bordered " id='pulmonaryForm'>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/services/pulmonary_medicine.js');?>" type="text/javascript"></script>  
