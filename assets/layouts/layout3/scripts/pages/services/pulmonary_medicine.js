...
$('#btnUpdate').click(function() {
    ...
    $.ajax({
		...
		method: "POST",
		data: new FormData(document.getElementById('pulmonaryForm')),
		contentType: false,
		cache: false,
		processData: false,
		dataType: "json",
		success: function (res) {
			if (res.success == true) {
                showSuccessToastr('Update Pulmonary Medicine');
            }
            else {
                showErrorToastr('Update Pulmonary Medicine');
            }
        },
        error: function (err) {
            showErrorToastr('Update Pulmonary Medicine');
