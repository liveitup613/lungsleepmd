                                    ...
                                    <div class='main-container'>
                                        ...
                                        <div class="header__breadcrumb"
                                            style="background-blend-mode: multiply;
                                                    background-image:url(<?php echo base_url('assets/frontend/images/patient-form.png');?>);
                                                    background-color : rgb(33 52 60 / 68%);
                                                    background-size: cover;
                                                    background-position: center;">
                                            <h1 class="header__breadcrumb--title">Patient Forms</h1>
                                        </div>
                                        ...
                                        <main class="main">
                                            <div class="service-container">
                                                <div class='content'>                                                    
                                                    ...
                                                    <div class='step-description'>
                                                        <h2>Step 3: Bring completed form(s) to scheduled appointment</h2>
                                                        <div class='et_pb_module et_pb_divider et_pb_divider_4 mc_divider et_pb_divider_position_ et_pb_space'></div>                                                                                         
                                                    </div>
                                                    <div class='step-detail'>
                                                        <p>We ask that all patients arrive 15 minutes early with your isurance card in hand.</p>
                                                    </div>

                                                    <div class='patient-form-quote'>
                                                        <h4>If you have any further questions please <a href="<?php echo base_url('contact-us');?>">contact</a> the office directly</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </main>
