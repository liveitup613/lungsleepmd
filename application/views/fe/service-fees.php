                                    ...
                                    <div class='main-container'>
                                        ...
                                        <div class="header__breadcrumb"
                                            style="background-blend-mode: multiply;
                                                    background-image:url(<?php echo base_url('assets/frontend/images/vaccination-2722937_1920-400x250.jpg');?>);
                                                    background-color : rgb(33 52 60 / 68%);
                                                    background-size: cover;
                                                    background-position: center;">
                                            <h1 class="header__breadcrumb--title">Service Fees</h1>
                                        </div>
                                                    ...
                                                    <form id='appointment-form'>
                                                        <div class='appointment-form'>
                                                            <div class='form-group col-5'>
                                                                <label class='form-label'>First Name<span class="field_required">*</span></label>
                                                                <input type='text' class='form-control' id='first-name' name='first-name' required>
                                                            </div>
                                                            <div class='form-group col-5'>
                                                                <label class='form-label'>Last Name<span class="field_required">*</span></label>
                                                                <input type='text' class='form-control' id='last-name' name='last-name' required>
                                                            </div>
                                                            <div class='form-group col-5'>
                                                                <label class='form-label'>Phone Number<span class="field_required">*</span></label>
                                                            ...
                                                            <div class='form-group col-5'>
                                                                <label class='form-label'>City<span class="field_required">*</span></label>
                                                                <input type='text' class='form-control' id='city' name='city' required>
                                                            </div>
                                                            <div class='form-group col-5'>
                                                                <label class='form-label'>State/Province<span class="field_required">*</span></label>
                                                                <input type='text' class='form-control' id='state' name='state' required>
                                                            </div>
                                                            <div class='form-group col-5'>
                                                                <label class='form-label'>Postal/Zip Code<span class="field_required">*</span></label>
                                                                <input type='text' class='form-control' id='zip-code' name='zip-code'>
                                                            </div>
                                                            <div class='form-group col-5'>
                                                                <label class='form-label'>Country<span class="field_required">*</span></label>                           
                                                            ...
                                                            <div class='form-group col-5'>
                                                                <label class='form-label'>Appointment Date<span class="field_required">*</span></label>
