...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Additional Services | Epignosis Specialty Practice</title>
    ...
    <body class="page-container-bg-solid page-boxed">     
                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span href="#">Addtional Services</span>  
                            </li>                            
                        </ul>
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Additional Services Content</span>
                                            </div>                                         
                                        </div>
                                            ...
                                            <form action="#" class="form-horizontal form-bordered ">
                                                <div class="form-body">                                                     
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Additional Services</label>
                                                        <div class="col-md-9">
                                                                ...
                                                                foreach ($services as $service) {
                                                                    ?>
                                                                        <div class='core-value'>                                                                
                                                                            <input type='text' value='<?php echo $service['Title'];?>' class='form-control' id='value<?php echo $service['ID'];?>'>
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn green btn-sm" onclick='editService(<?php echo $service["ID"];?>)'>UPDATE</button>
                                                                                <button type="button" class="btn red btn-sm" onclick='deleteService(<?php echo $service["ID"];?>)'>DELETE</button>                                                                                
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/services/additional_services.js');?>" type="text/javascript"></script>
