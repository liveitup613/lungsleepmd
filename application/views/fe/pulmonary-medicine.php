                                    ...
                                    <div class='main-container'>
                                        ...
                                        <div class="header__breadcrumb"
                                            style="background-blend-mode: multiply;
                                                    background-image:url(<?php echo base_url('assets/frontend/images/medicus177.jpeg');?>);
                                                    background-color : rgba(0,45,53,0.7);
                                                    background-size: cover;">
                                            <h1 class="header__breadcrumb--title">Pulmonary Medicine</h1>
                                        </div>
