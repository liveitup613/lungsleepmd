...
<body
                                    ...
                                    <div class='main-container'>
                                        ...
                                        <div class="header__breadcrumb"
                                            style="background-blend-mode: multiply;
                                                    background-image:url(<?php echo base_url('assets/frontend/images/medicus197.jpg');?>);
                                                    background-color : rgb(33 52 60 / 68%);
                                                    background-size: cover;
                                                    background-position: center;">
                                            <h1 class="header__breadcrumb--title">What’s New At Epignosis</h1>
                                        </div>
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/frontend/scripts/pages/blogs.js');?>"></script>
